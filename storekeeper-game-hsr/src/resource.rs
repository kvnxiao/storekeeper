...
mod tests {
    ...
    #[test]
    fn trailblaze_power_display_name() {
        let resource =
    ...
    #[test]
    fn trailblaze_power_serialization_format() {
        let resource =
            HsrResource::TrailblazePower(StaminaResource::new(180, 240, Timestamp::now(), 360));
    ...
    #[test]
    fn trailblaze_power_serde_roundtrip() {
        let original =
            HsrResource::TrailblazePower(StaminaResource::new(180, 240, Timestamp::now(), 360));
    ...
    #[test]
    fn trailblaze_power_serializes_full_at_as_utc_z() {
