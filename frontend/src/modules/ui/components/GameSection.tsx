...
const disclosureStyle =
  "group/section overflow-hidden rounded-lg bg-white shadow-sm ring-1 ring-zinc-950/5 dark:bg-zinc-800 dark:ring-white/10";

const headerStyle =
  "relative flex w-full cursor-pointer items-center gap-2 px-3 py-2 transition-colors hover:bg-zinc-50 dark:hover:bg-zinc-700";
